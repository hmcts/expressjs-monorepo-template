...
echo ""
echo "📝 Configuration:"
echo "  Team (dtsse): $TEAM_NAME_LOWER"
echo "  Team (DTSSE): $TEAM_NAME_INPUT"
...
echo "Replacing DTSSE..."
replace_in_files "\\bDTSSE\\b" "$TEAM_NAME_INPUT"

echo "Replacing dtsse..."
replace_in_files "\\bdtsse\\b" "$TEAM_NAME_LOWER"
