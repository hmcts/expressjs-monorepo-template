...
- If the branch contains an issue number (format: `feature/<issue-number>-description`), check if there is a specification for it in `docs/tickets/<issue-number>/specification.md`
